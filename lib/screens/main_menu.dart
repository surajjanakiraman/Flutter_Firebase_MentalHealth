  ...
  List<MenuItem> createMenuItems() {
    final menuItems = [
      ...
      new MenuItem("My Score", 'assets/images/myscore.jpg', Colors.yellow,
          () => new MyScore()),
      new MenuItem("Treatments", 'assets/images/doctor.png', Colors.brown,
          () => new Treatment()),
      new MenuItem("Journal", 'assets/images/journal.jpg', Colors.red,
          () => new Journal()),
      new MenuItem("Hotline", 'assets/images/feedback.png', Colors.purple,
          () => new Hotline()),
      new MenuItem(
          "Feedback", 'assets/images/think.png', Colors.blue, () => new Feed()),
      new MenuItem("Logout", 'assets/images/logout.png', Colors.blue,
          () => new Logout()),
    ];
    return menuItems;
  }
